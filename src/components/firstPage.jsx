...
<div className="mainContentText">
  ...
  КОММЕРЧЕСКОЕ <br/>
  ЗАДАНИЕ
  <Link to="/second"><button className="mainContentButton"><span className="mainContentButtonPointer">&#8594;</span><span className="mainContentButtonText">Что дальше?</span></button></Link>
</div>
